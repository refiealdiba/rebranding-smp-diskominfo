  ...
  return (
    <div className="px-4 py-10 font-inter bg-gray-50 min-h-screen">
      <div className="max-w-4xl mx-auto space-y-10">
        <h1 className="text-2xl font-bold text-smporange">Kelola Pengaduan</h1>

        {/* Form */}
        <div className="bg-white p-6 rounded-xl shadow-md space-y-4">
          <h2 className="text-lg font-semibold">
            {isEditing ? "Edit Pengaduan" : "Tambah Pengaduan"}
          </h2>
          <form
          ...
          >
            ...
            <div className="sm:col-span-2">
              <button
                type="submit"
                className="bg-smporange text-white px-4 py-2 rounded hover:bg-orange-600 transition"
              >
