...
const Achievements = () => {
    ...
    const paginatedAchievements = achievements.slice(startIndex, startIndex + ITEMS_PER_PAGE);
    ...
    const handleDelete = async (id) => {
        const result = await Swal.fire({
            ...
            text: "Data prestasi yang dihapus tidak bisa dikembalikan.",
            icon: "warning",
    ...
    return (
        <div className="flex flex-col gap-12 px-4 py-10 font-inter">
            <div className="font-bold self-start">
                <h1 className="text-lg sm:text-xl md:text-2xl text-smporange">Prestasi</h1>
            </div>
